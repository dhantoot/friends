...
interface Card1DivInvertedProps {
  className?: string;
  style?: React.CSSProperties;
}

const Card1DivInverted: React.FC<Card1DivInvertedProps> = ({ className, style }) => {
  return (
    <div className={`relative w-full aspect-[460/160] ${className}`} style={style}>
      {/* Background Layer with Vertically Flipped Soft Milky Card Gradient */}
      <div className="absolute inset-0 overflow-visible scale-y-[-1]">
        <svg className="w-full h-full" viewBox="0 0 460 160" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="divCardInvertedGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          <path
            ...
            fill="url(#divCardInvertedGradient)"
...
export default Card1DivInverted;
